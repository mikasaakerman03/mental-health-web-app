...
export const MentalHealthAssessment = () => {
  ...
  return (
    <>
      <div className="w-full min-h-full bg-white py-10 px-6 md:px-20 my-10">
        <h2 className="text-6xl sm:2xl font-bold text-[#4F3422] mb-6">{t('assessment.title')}</h2>
      ...
      <div className="m-5">
        <div className="bg-[#9BB167] rounded-[40px] p-10 flex flex-col md:flex-row items-center justify-between text-white">
          <div className="w-1/2 space-y-4 p-10">
            <h2 className="text-[60px] font-bold leading-tight">{t('assessment.scoreTitle')}</h2>
            <div className="flex flex-row gap-x-3 items-center">
              <div className="text-[30px] text-white/80">{t('assessment.scoreLabel')}</div>
          ...
          <div className="flex flex-col items-center w-1/2">
            <div className="bg-white text-[80px] text-[#4F3422] px-10 py-6 rounded-[1000px] shadow-md font-bold flex items-center gap-3">
              <img src={logoIcon} alt="" className="w-10 h-10" />
              78.2
            </div>
            <div className="flex gap-10 mt-6 text-white text-center">
              <div>
