...
export const SleepOverview = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-3">
      {/* REM Card */}
      <div className="sm:w-[50%] py-4 bg-[#fff] rounded-xl flex flex-col items-center justify-center shadow-sm relative">
        <div className="text-2xl text-[#5d4037] font-bold text-center mb-4 flex items-center gap-1">
          {t("youSleptFor")}
        </div>
