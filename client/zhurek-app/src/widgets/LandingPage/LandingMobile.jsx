...
export const LandingMobile = () => {
  ...
  return (
    <div className='relative min-h-[100vh] w-full flex flex-col h-full font-bold overflow-hidden'>
      {/* Block 1 */}
      <div className='relative w-full h-[70vh] z-10 overflow-hidden'>
        <div className="absolute -top-3 -right-[30%] w-[1500px] h-[1500px] bg-[#E1E1E0] rounded-full opacity-30 z-0"></div>
        <div className="w-full px-10 pt-10 relative z-10">
          <div className='flex flex-col'>
            <p className='text-[#736B66] p-3 mx-auto rounded-3xl bg-[#F5F5F5] max-w-max'>
              {t('landing.missionTag')}
            </p>

            <div className="mt-6 text-center flex flex-col gap-y-0 leading-tight">
              <p className='m-0 p-0 text-[35px] text-[#4F3422]'>{t('landing.title1')}</p>
              <p className='m-0 p-0 text-[35px] text-[#4F3422]'>{t('landing.title2')}</p>
              <p className='m-0 p-0 text-[35px] text-[#966A51]'>{t('landing.title3')}</p>
            </div>

            <p className='mt-5 text-[#736B66] font-medium text-[15px] text-center'>{t('landing.promoText')}</p>

            <div className="flex flex-col mt-4 gap-4">
              {/* Кнопка "Get In Touch" */}
              <button className="flex justify-center items-center gap-2 bg-[#4F3422] text-white font-bold px-6 py-3 rounded-full text-lg transition-all duration-300 hover:opacity-80"
              ...
              {/* Кнопка "Download App" */}
              <button className="flex justify-center items-center gap-2 border-2 border-white bg-[#F7F4F2] text-[#4F3422] font-bold px-6 py-3 rounded-full text-lg transition-all duration-300 hover:opacity-80"
      ...
      <div className='bg-[#F7F4F2] m-3 rounded-3xl'>
        <div className="mx-auto w-full px-4 pt-10 flex flex-col">
          <div className="w-full">
            ...
            <p className='text-[#4F3422] mx-auto text-center py-10 text-2xl'>
            ...
            <div className="mt-10 mb-5 w-full">
              <button className="max-w-max mx-auto flex items-center gap-2 px-6 py-3 rounded-full bg-[#4F3422] text-white font-semibold text-xl">
      ...
      <div className="bg-[#9BB167] m-3 rounded-3xl">
        <div className="w-full py-10 px-6 flex flex-col">
          <p className='text-white mx-auto max-w-max p-3 mb-7 rounded-3xl border border-white'>{t('landing.coreFeatures')}</p>
          <p className='text-white mx-auto pb-10 text-2xl font-[800]'>{t('landing.featureTitle')}</p>
      ...
      {/* Block 5 */}
      <div className="h-full flex flex-col md:flex-row items-center justify-between gap-12 px-6 py-10">
        {/* Left content */}
        <div className="w-full md:w-1/2 text-center">
          <p className="text-[#736B66] mx-auto max-w-max p-2 px-4 rounded-full border border-[#736B66] text-xl mb-8">
            {t('landing.mainBenefit1')}
          </p>
          <h2 className="text-[#4F3422] text-2xl font-extrabold mb-9">
            {t('landing.assessmentTitle')}
          </h2>
          <p className="text-[#736B66] text-lg mb-7 w-full">
            {t('landing.assessmentDesc1')}
          </p>
          <p className="text-[#736B66] text-lg mb-10 w-full">
            {t('landing.assessmentDesc2')}
          </p>

          <div className="flex gap-10 mt-4">
            <div>
              <p className="text-2xl text-[#4F3422] font-extrabold">99.5%</p>
              <p className="text-[#736B66] tracking-wide uppercase text-xl">Connect Rate</p>
            </div>
            <div>
              <p className="text-2xl text-[#4F3422] font-extrabold">25K*</p>
      ...
      {/* Block 6 */}
      <div className="h-full flex items-center gap-12 py-8 px-6">
        ...
        <div className="w-full md:w-1/2 text-center">
          ...
          <ul className="space-y-4">
            <li className="flex items-center text-[#4F3422] font-semibold text-lg">
      ...
      <div className="h-full flex flex-col md:flex-row items-center justify-between gap-12 px-6 py-10">
        ...
        <div className="w-full md:w-1/2 text-center">
          ...
          <div>
            ...
            <div className="w-full h-[6px] bg-[#D9D9D9] mt-2 mb-1 rounded-full">
      ...
      <div className="bg-[#F7F4F2] mt-10 m-3 rounded-3xl">
        <div className="w-full px-6 py-8">
          <div className="flex flex-col items-center justify-center text-center">
            <h2 className="text-[#4F3422] text-2xl font-extrabold mb-4" dangerouslySetInnerHTML={{ __html: t('landing.ctaTitle') }} />
            <p className="text-[#736B66] text-lg">{t('landing.ctaText')}</p>
          </div>
      ...
      <div className="bg-gradient-to-br from-[#A8C686] to-[#9BB167] m-3 rounded-3xl overflow-hidden relative z-10">
        <div className="flex flex-col-reverse md:flex-row items-center justify-between px-6 py-8">
          ...
          <div className="w-full md:w-1/2 text-white relative z-10">
            <button className="border mx-auto border-white px-4 py-2 rounded-full mb-6 text-sm hover:bg-white hover:text-[#4F3422] transition">
              {t('landing.downloadApp')}
            </button>
            <h2 className="text-2xl text-center font-extrabold leading-tight mb-6" dangerouslySetInnerHTML={{ __html: t('landing.appBlockTitle') }} />

            <div className="flex flex-wrap gap-4 mt-6 w-full">
              <button className="flex w-full justify-center items-center gap-2 bg-[#4F3422] text-white font-bold px-6 py-3 rounded-full text-lg hover:opacity-90"
                onClick={() => { navigate('/guest/sign-in') }}>
                {t('buttons.getInTouch')}
                <img src={arrowRightIcon} alt="arrow right" className="w-5 h-5" />
              </button>

              <button className="flex w-full justify-center items-center gap-2 bg-[#FB8728] text-white font-bold px-6 py-3 rounded-full text-lg hover:opacity-90"
                onClick={() => { navigate('/guest/sign-up') }}>
                {t('landing.signUp')}
                <img src={arrowRightIcon} alt="arrow right" className="w-5 h-5" />
              </button>
