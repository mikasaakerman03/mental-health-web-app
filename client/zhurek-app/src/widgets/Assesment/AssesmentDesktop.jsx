...
import circleOrange from "../../shared/assets/images/abs_circle_orange.png";
...
import { MentalHealthAssessment } from '../../features/MentalHealthAsessment/MentalHealthAsessment';
import { Footer } from '../../shared/ui/Footer/Footer';

export const AssesmentDesktop = () => {
  ...
  return (
    <div className='relative min-h-[100vh] w-full flex flex-col h-full overflow-hidden'>
      {/* Block 1 */}
      <div className='relative w-full h-[90vh] z-10 overflow-hidden'>
        <div>
          <img src={circleOrange} alt="" className="absolute -top-3 -left-[0.5%] w-[800px] h-[800px] bg-[#E1E1E0] z-0" />
        </div>
          ...
          <div className="w-full md:w-1/2 flex flex-col font-bold">
            <div className="mt-6 flex flex-col gap-y-0 leading-tight">
              ...
              <div className="relative inline-block">
                <svg
                  className="absolute -bottom-1 -right-[30%] -translate-x-1/2 z-0"
                  width="420"
                  height="20"
                  viewBox="0 0 320 70"
                ...
                <span className="relative z-10 text-[75px] font-extrabold text-[#ab7d5f]">
                  {t('assessment.title3')}
                </span>
              </div>
            </div>
            <p className='mt-5 text-[#736B66] font-medium text-[20px]'>
              {t('assessment.subtitle1')}
            </p>
            <p className='text-[#736B66] font-medium text-[20px]'>
